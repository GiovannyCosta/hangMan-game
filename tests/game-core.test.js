...
const { normalizeLetter, chooseEntry, createMask, applyGuess, imageLevel, calculateScore } = require("../assets/js/game-core.js");
...
test("cria a máscara preservando espaços", () => {
  assert.deepEqual(createMask("SAO PAULO"), ["_", "_", "_", " ", "_", "_", "_", "_", "_"]);
});
